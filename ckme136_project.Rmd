...
# Desc: Outliers cause issues with normalization, instead of removing them, substitute the outliers with upper fence values
...
# Desc: REturns a normalized dataframe
...
features=c("Avg.Annual","g","ab","woba","r", "h", "double", "triple", "hr", "rbi", "sb","cs","bb","so","ibb","hbp", "sh","sf","g_idp","po","a","e","age")
...
# *** The far right of cluster 1 contains a cluster of players.  This corresponds to Cluster 1 from kmeans
...
# Density based clustering produces 7 clusters and noise
# *** Exceptional players are treated as noise 
# *** Cluster 1 represent the average and part time players in kmeans cluster 2 and 3
